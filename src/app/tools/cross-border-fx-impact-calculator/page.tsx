...
export const metadata: Metadata = {
  title: "Cross-Border FX Impact Calculator: PayPal vs Stripe vs Wise ",
  ...
  alternates: {
    canonical: "https://dailyfinance.tools/tools/cross-border-fx-impact-calculator",
  },
  openGraph: {
    title: "Cross-Border FX Impact Calculator | Stop Losing Money",
    description: "Compare exactly how much Stripe, PayPal, and Wise are charging you to get paid internationally. Uncover hidden FX spreads and markup fees.",
    url: "https://dailyfinance.tools/tools/cross-border-fx-impact-calculator",
  ...
  twitter: {
    ...
    description: "Compare exactly how much Stripe, PayPal, and Wise are charging you to get paid internationally.",
  },
}
