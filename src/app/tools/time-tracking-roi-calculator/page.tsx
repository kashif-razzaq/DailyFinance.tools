...
export const metadata: Metadata = {
  title: "Freelance Time Tracking ROI Calculator: Cost of Scope Creep",
  ...
  alternates: {
    canonical: "https://dailyfinance.tools/tools/time-tracking-roi-calculator",
  },
  openGraph: {
    title: "Time Tracking ROI & Scope Creep Calculator",
    description: "See exactly how much undocumented scope creep and manual administrative work is costing your freelance business every year.",
    url: "https://dailyfinance.tools/tools/time-tracking-roi-calculator",
  ...
  twitter: {
    ...
    title: "Freelance Scope Creep Calculator",
    description: "Calculate your lost revenue to unbilled hours.",
  },
}
