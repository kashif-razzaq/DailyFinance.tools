...
export const metadata: Metadata = {
  title: "S-Corp Salary vs Dividend Calculator & FICA Tax Optimizer",
  ...
  alternates: {
    canonical: "https://dailyfinance.tools/tools/s-corp-salary-dividend-calculator",
  },
  openGraph: {
    title: "S-Corp Tax Optimizer | Maximize Freelance Savings",
    description: "Calculate exactly how much you'll save in FICA taxes by converting your freelance LLC to an S-Corp.",
    url: "https://dailyfinance.tools/tools/s-corp-salary-dividend-calculator",
  ...
  twitter: {
    ...
    title: "S-Corp Salary vs Dividend Calculator",
    description: "Calculate exact tax savings by converting your freelance LLC to an S-Corp.",
  },
}
