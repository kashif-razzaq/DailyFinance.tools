...
export const metadata: Metadata = {
  title: "Freelance Flat Fee Project Quoter & Risk Calculator",
  ...
  alternates: {
    canonical: "https://dailyfinance.tools/tools/project-flat-fee-quoter",
  },
  openGraph: {
    title: "Freelance Flat Fee Project Quoter | Protect Your Profit",
    description: "Convert hourly estimates into robust, highly profitable flat-fee quotes that protect you from scope creep and endless revisions.",
    url: "https://dailyfinance.tools/tools/project-flat-fee-quoter",
  ...
  twitter: {
    ...
    title: "Freelance Flat Fee Project Quoter",
    description: "Automatically account for scope creep, communication buffers, and risk premiums.",
  },
}
