            ...
            <table className="w-full text-left border-collapse m-0">
              ...
              <tbody className="divide-y divide-neutral-100 font-mono text-sm">
                <tr className="hover:bg-neutral-50 transition-colors">
                  ...
                  <td className="py-4 px-6 font-semibold text-[#064E3B]">$120 - $257+/hr</td>
                </tr>
                ...
                <tr className="hover:bg-neutral-50 transition-colors">
                  ...
                  <td className="py-4 px-6 font-semibold text-[#064E3B]">$90 - $157+/hr</td>
                </tr>
                <tr className="hover:bg-neutral-50 transition-colors bg-[#FAFAFA]">
                ...
                <tr className="hover:bg-neutral-50 transition-colors">
                  ...
                  <td className="py-4 px-6 font-semibold text-[#064E3B]">$150 - $357+/hr</td>
                </tr>
              </tbody>
            </table>
          </div>
