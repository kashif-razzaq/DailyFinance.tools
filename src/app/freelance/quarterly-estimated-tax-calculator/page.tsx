...
export const metadata: Metadata = generateCalculatorMetadata({
  title: "Quarterly Estimated Tax Calculator: Free 1099 Tax Estimator",
...
export default function QuarterlyTaxesCalculatorPage() {
  return (
    <>
        ...
        "step": [
          {
            ...
            "text": "Input your expected annual freelance or 1099 income into the calculator."
          },
          {
            "@type": "HowToStep",
            "name": "Select Filing Status",
            "text": "Choose your correct tax filing status (Single, Married, etc.) to apply the correct standard deduction and tax brackets."
          },
          {
            "@type": "HowToStep",
            "name": "Input Deductions",
            "text": "Enter any expected business expenses or deductions to accurately determine your net taxable income."
          },
          {
            "@type": "HowToStep",
            "name": "Review Quarterly Payments",
            "text": "View the calculated quarterly estimated tax payments you need to make to the IRS to avoid underpayment penalties."
          }
        ]
      })}} />
      ...
      <Script id="schema-webpage" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@graph": [
          {
            "@type": "WebPage",
            "@id": "https://dailyfinance.tools/freelance/quarterly-estimated-tax-calculator",
            "url": "https://dailyfinance.tools/freelance/quarterly-estimated-tax-calculator",
            "name": "Quarterly Estimated Tax Calculator: Free 1099 Tax Estimator",
            "description": "Calculate your 1099 quarterly estimated taxes instantly. Supports 2026 IRS federal brackets, self-employment tax, QBI deduction, and state taxes."
          },
          {
            "@type": "BreadcrumbList",
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "name": "Quarterly Estimated Tax Calculator",
                "item": "https://dailyfinance.tools/freelance/quarterly-estimated-tax-calculator"
              }
            ]
          }
        ]
