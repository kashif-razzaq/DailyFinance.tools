...
export const metadata: Metadata = {
  ...
  title: {
    default: 'DailyFinance | Professional Financial Calculators',
    template: '%s | DailyFinance',
  },
  description:
    'Free suite of 50+ professional financial calculators. Optimize taxes, investments, cash flow, and wealth building with precision-engineered tools. No signup required.',
  keywords: [
