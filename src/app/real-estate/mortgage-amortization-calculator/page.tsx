...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'See how extra payments destroy interest over the life of your loan.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Mortgage Amortization?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "See how extra payments destroy interest over the life of your loan."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Mortgage Amortization</h2>
          <p>See how extra payments destroy interest over the life of your loan.</p>

          <h3>Why Mortgage Amortization Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Mortgage Amortization tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
