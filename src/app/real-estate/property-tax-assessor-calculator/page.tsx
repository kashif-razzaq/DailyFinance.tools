...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Estimate the impact of millage rates and assessed value on your property taxes.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Property Tax Assessor?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Estimate the impact of millage rates and assessed value on your property taxes."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Property Tax Assessor</h2>
          <p>Estimate the impact of millage rates and assessed value on your property taxes.</p>

          <h3>Why Property Tax Assessor Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Property Tax Assessor tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
