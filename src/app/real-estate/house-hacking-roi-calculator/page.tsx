...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Offset your mortgage with rental income and calculate your true ROI.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the House Hacking ROI?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Offset your mortgage with rental income and calculate your true ROI."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the House Hacking ROI</h2>
          <p>Offset your mortgage with rental income and calculate your true ROI.</p>

          <h3>Why House Hacking ROI Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this House Hacking ROI tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
