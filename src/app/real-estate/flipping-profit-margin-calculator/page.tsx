...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Calculate wholesale offers and flipping profit using the 70% rule.',
  slug: 'flipping-profit-margin-calculator',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Flipping Profit Margin?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Calculate wholesale offers and flipping profit using the 70% rule."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Flipping Profit Margin</h2>
          <p>Calculate wholesale offers and flipping profit using the 70% rule.</p>

          <h3>Why Flipping Profit Margin Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Flipping Profit Margin tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
