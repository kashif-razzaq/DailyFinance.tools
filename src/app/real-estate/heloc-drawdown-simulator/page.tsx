...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Estimate interest-only period payments for your Home Equity Line of Credit.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the HELOC Drawdown?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Estimate interest-only period payments for your Home Equity Line of Credit."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the HELOC Drawdown</h2>
          <p>Estimate interest-only period payments for your Home Equity Line of Credit.</p>

          <h3>Why HELOC Drawdown Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this HELOC Drawdown tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
