...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Analyze your Buy, Rehab, Rent, Refinance, Repeat strategy.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the BRRRR Strategy Analyzer?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Analyze your Buy, Rehab, Rent, Refinance, Repeat strategy."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the BRRRR Strategy Analyzer</h2>
          <p>Analyze your Buy, Rehab, Rent, Refinance, Repeat strategy.</p>

          <h3>Why BRRRR Strategy Analyzer Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this BRRRR Strategy Analyzer tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
