...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Calculate cap rates and monthly net operating income for rental properties.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Rental Cash Flow?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Calculate cap rates and monthly net operating income for rental properties."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Rental Cash Flow</h2>
          <p>Calculate cap rates and monthly net operating income for rental properties.</p>

          <h3>Why Rental Cash Flow Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Rental Cash Flow tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
