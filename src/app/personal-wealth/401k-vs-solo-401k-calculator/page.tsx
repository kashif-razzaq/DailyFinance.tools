...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Compare contribution limits for self-employed individuals.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the 401k vs Solo 401k?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Compare contribution limits for self-employed individuals."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the 401k vs Solo 401k</h2>
          <p>Compare contribution limits for self-employed individuals.</p>

          <h3>Why 401k vs Solo 401k Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this 401k vs Solo 401k tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
