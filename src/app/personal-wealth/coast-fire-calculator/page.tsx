...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'When can you stop contributing to retirement and let compound interest take over?',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Coast FIRE Calculator?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "When can you stop contributing to retirement and let compound interest take over?"
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Coast FIRE Calculator</h2>
          <p>When can you stop contributing to retirement and let compound interest take over?</p>

          <h3>Why Coast FIRE Calculator Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Coast FIRE Calculator tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
