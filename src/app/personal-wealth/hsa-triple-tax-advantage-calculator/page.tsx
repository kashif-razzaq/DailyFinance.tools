...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Model investing your healthcare savings.',
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Model investing your healthcare savings."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the HSA Triple Tax Advantage</h2>
          <p>Model investing your healthcare savings.</p>

          <h3>Why HSA Triple Tax Advantage Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this HSA Triple Tax Advantage tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
