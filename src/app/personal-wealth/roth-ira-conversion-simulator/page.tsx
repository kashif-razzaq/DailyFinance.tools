...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Estimate tax implications of a backdoor Roth conversion.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Roth IRA Conversion?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Estimate tax implications of a backdoor Roth conversion."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Roth IRA Conversion</h2>
          <p>Estimate tax implications of a backdoor Roth conversion.</p>

          <h3>Why Roth IRA Conversion Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Roth IRA Conversion tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
