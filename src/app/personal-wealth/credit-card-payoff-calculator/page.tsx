...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Crush high-interest credit card debt.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Credit Card Payoff?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Crush high-interest credit card debt."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Credit Card Payoff</h2>
          <p>Crush high-interest credit card debt.</p>

          <h3>Why Credit Card Payoff Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Credit Card Payoff tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
