...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Calculate what your money is worth in the future.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Inflation Purchasing Power?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Calculate what your money is worth in the future."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Inflation Purchasing Power</h2>
          <p>Calculate what your money is worth in the future.</p>

          <h3>Why Inflation Purchasing Power Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Inflation Purchasing Power tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
