...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Visualize the 8th wonder of the world.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Compound Interest Scaler?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Visualize the 8th wonder of the world."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Compound Interest Scaler</h2>
          <p>Visualize the 8th wonder of the world.</p>

          <h3>Why Compound Interest Scaler Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Compound Interest Scaler tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
