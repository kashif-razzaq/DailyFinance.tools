...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Overview of your assets minus liabilities.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Net Worth Tracker?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Overview of your assets minus liabilities."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Net Worth Tracker</h2>
          <p>Overview of your assets minus liabilities.</p>

          <h3>Why Net Worth Tracker Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Net Worth Tracker tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
