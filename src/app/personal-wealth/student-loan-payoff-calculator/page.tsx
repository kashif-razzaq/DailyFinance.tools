...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Avalanche your student debt.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Student Loan Payoff?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Avalanche your student debt."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Student Loan Payoff</h2>
          <p>Avalanche your student debt.</p>

          <h3>Why Student Loan Payoff Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Student Loan Payoff tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
