...
export const metadata: Metadata = generateCalculatorMetadata({
  title: 'High Yield Savings & CD',
  description: 'Park your tax savings efficiently.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the High Yield Savings & CD?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Park your tax savings efficiently."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the High Yield Savings & CD</h2>
          <p>Park your tax savings efficiently.</p>

          <h3>Why High Yield Savings & CD Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this High Yield Savings & CD tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
