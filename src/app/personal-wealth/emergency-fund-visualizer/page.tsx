...
export const metadata: Metadata = generateCalculatorMetadata({
  ...
  description: 'Calculate your runway based on your actual monthly burn rate.',
...
export default function Page() {
  ...
  const schema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the Emergency Fund Visualizer?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Calculate your runway based on your actual monthly burn rate."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      >
        {() => (
          ...
          <h2>Mastering the Emergency Fund Visualizer</h2>
          <p>Calculate your runway based on your actual monthly burn rate.</p>

          <h3>Why Emergency Fund Visualizer Matters</h3>
          ...
          <h3>Conclusion</h3>
          <p>We built this Emergency Fund Visualizer tool to empower you with institutional-grade analytics. Save your scenarios, compare different options, and make data-driven decisions. Your future self will thank you.</p>
    ` }} />
          </div>
        )}
      </ToolLayout>
